...
target_countries = ["China", "Japan", "South Korea", "Malaysia", "Saudi Arabia", "Thailand", "United States of America", "Singapore", "Indonesia", "Taiwan", "India", "Australia", "United Arab Emirates", "Vietnam", "Germany", "Philippines"]
...
df.to_csv('data/cleaned data/unga_voting_4.csv', index=False)